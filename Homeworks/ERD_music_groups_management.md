...
# ERD для системы, предназначенной для менеджера музыкальных групп

* [Задание](#задание)
* [Ход выполнения](#ход-выполнения)
* [Выявление сущностей](#выявление-сущностей)
* [ERD](#ERD)
* [Словарь данных](#словарь-данных)
* [Проверка условий по SQL запросам](#проверка-условий-по-SQL-запросам)
...
Мой порядок рассуждений при моделировании этой системы:
...
| Таблица       | Атрибут              | Тип           | Описание                            | Ограничения    | Примечания                                                                                                                                                                                                                                                                                                                                         |
| ------------- | -------------------- | ------------- | ----------------------------------- | -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| charts        |                      |               | Хит-парады                          |                |                                                                                                                                                                                                                                                                                                                                                    |
|               | chart_id             | INT           | Идентификатор хит-парада            | PK NOT NULL    |                                                                                                                                                                                                                                                                                                                                                    |
|               | chart_date           | DATE          | Дата хит-парада                     |                |                                                                                                                                                                                                                                                                                                                                                    |
| cities        |                      |               | Населенные пункты                   |                |                                                                                                                                                                                                                                                                                                                                                    |
|               | city_id              | INT           | Идентификатор населенного пункта    | PK NOT NULL    |                                                                                                                                                                                                                                                                                                                                                    |
|               | city_name            | VARCHAR(50)   | Название населенного пункта         |                |                                                                                                                                                                                                                                                                                                                                                    |
| concerts      |                      |               | Концерты                            |                |                                                                                                                                                                                                                                                                                                                                                    |
|               | tour_id              | INT           | Гастрольная программа (ссылка)      | FK - TOURS     |                                                                                                                                                                                                                                                                                                                                                    |
|               | city_id              | INT           | Место проведения (ссылка)           | FK - CITIES    |                                                                                                                                                                                                                                                                                                                                                    |
|               | concert_date         | DATE          | Дата проведения                     |                |                                                                                                                                                                                                                                                                                                                                                    |
|               | ticket_price         | DECIMAL(10,2) | Цена билета                         | > 0            |                                                                                                                                                                                                                                                                                                                                                    |
| countries     |                      |               | Страны                              |                |                                                                                                                                                                                                                                                                                                                                                    |
|               | country_id           |               | Идентификатор страны                |                |                                                                                                                                                                                                                                                                                                                                                    |
|               | country_name         |               | Название страны                     |                |                                                                                                                                                                                                                                                                                                                                                    |
| groups        |                      |               | Группы                              |                |                                                                                                                                                                                                                                                                                                                                                    |
|               | group_id             | INT           | Идентификатор группы                | PK NOT NULL    |                                                                                                                                                                                                                                                                                                                                                    |
|               | group_name           | VARCHAR(100)  | Название группы                     |                |                                                                                                                                                                                                                                                                                                                                                    |
|               | founded_year         | INT           | Год создания группы                 |                |                                                                                                                                                                                                                                                                                                                                                    |
|               | country_id           | INT           | Страна (ссылка)                     | FK - COUNTRIES |                                                                                                                                                                                                                                                                                                                                                    |
|               | chart_position       | INT           | Позиция в последнем хит-параде      | > 0            | Вычисляемый атрибут - наименьшая позиция песен группы в последнем чарте.  <br>  <br>Последний чарт определяется по максимальной дате (chart_date) в таблице charts.                                                                                                                                                                                |
| group_members |                      |               | Участники группы                    |                |                                                                                                                                                                                                                                                                                                                                                    |
|               | group_id             | INT           | Группа (ссылка)                     | FK - GROUPS    |                                                                                                                                                                                                                                                                                                                                                    |
|               | musician_id          | INT           | Музыкант (ссылка)                   | FK - MUSICIANS |                                                                                                                                                                                                                                                                                                                                                    |
|               | role_id              | INT           | Роль музыканта в группе             | FK - ROLES     |                                                                                                                                                                                                                                                                                                                                                    |
| musicians     |                      |               | Музыканты                           |                |                                                                                                                                                                                                                                                                                                                                                    |
|               | musician_id          | INT           | Идентификатор музыканта             | PK NOT NULL    |                                                                                                                                                                                                                                                                                                                                                    |
|               | full_name            | VARCHAR(100)  | ФИО музыканта                       |                |                                                                                                                                                                                                                                                                                                                                                    |
|               | birth_date           | DATE          | Дата рождения                       |                |                                                                                                                                                                                                                                                                                                                                                    |
| roles         |                      |               | Роли                                |                |                                                                                                                                                                                                                                                                                                                                                    |
|               | role_id              | INT           | Идентификатор роли                  | PK NOT NULL    |                                                                                                                                                                                                                                                                                                                                                    |
|               | role_name            | VARCHAR(50)   | Название роли                       |                |                                                                                                                                                                                                                                                                                                                                                    |
| songs         |                      |               | Песни                               |                |                                                                                                                                                                                                                                                                                                                                                    |
|               | song_id              | INT           | Идентификатор песни                 | PK NOT NULL    |                                                                                                                                                                                                                                                                                                                                                    |
|               | song_name            | VARCHAR(100)  | Название песни                      |                |                                                                                                                                                                                                                                                                                                                                                    |
|               | group_id             | INT           | Группа-исполнитель                  | FK - GROUPS    |                                                                                                                                                                                                                                                                                                                                                    |
|               | composer_id          | INT           | Композитор (ссылка)                 | FK - MUSICIANS |                                                                                                                                                                                                                                                                                                                                                    |
|               | lyrics_author_id     | INT           | Автор текста (ссылка)               | FK - MUSICIANS |                                                                                                                                                                                                                                                                                                                                                    |
|               | release_date         | DATE          | Дата создания песни                 |                |                                                                                                                                                                                                                                                                                                                                                    |
| songs_charts  | song_id              | INT           | Песня (ссылка)                      | FK - SONGS     |                                                                                                                                                                                                                                                                                                                                                    |
|               | chart_id             | INT           | Хит-парад (ссылка)                  | FK - CHARTS    |                                                                                                                                                                                                                                                                                                                                                    |
|               | song_position        | INT           | Позиция песни в хит-параде          | > 0            |                                                                                                                                                                                                                                                                                                                                                    |
| tours         |                      |               | Гастроли                            |                |                                                                                                                                                                                                                                                                                                                                                    |
|               | tour_id              | INT           | Идентификатор гастрольной программы | PK NOT NULL    |                                                                                                                                                                                                                                                                                                                                                    |
|               | tour_name            | VARCHAR(100)  | Название гастрольной программы      |                |                                                                                                                                                                                                                                                                                                                                                    |
|               | group_id             | INT           | Выступаюшая группа (ссылка)         | FK - GROUPS    |                                                                                                                                                                                                                                                                                                                                                    |
|               | start_date           | DATE          | Дата начала выступлений             |                | Вычисляемый атрибут - дата первого концерта, входящего в тур  <br>  <br>average_ticket_price =  <br>AVG(concerts.ticket_price)  <br>WHERE concerts.tour_id = tours.tour_id  <br>  <br>Использовать триггер - при добавлении или изменении концерта  <br>- пересчитать average_ticket_price  <br>- обновить start_date и end_date                   |
|               | end_date             | DATE          | Дата окончания выступлений          |                | Вычисляемый атрибут - дата последнего концерта, входящего в тур  <br>  <br>start_date =  <br>MIN(concerts.concert_date)  <br>WHERE concerts.tour_id = tours.tour_id  <br>  <br>Использовать триггер - при добавлении или изменении концерта  <br>- пересчитать average_ticket_price  <br>- обновить start_date и end_date                          |
|               | average_ticket_price | DECIMAL(10,2) | Средняя цена билета                 |                | Вычисляемый атрибут -  <br>среднее значение ticket_price по всем концертам, входящим в тур  <br>  <br>end_date =  <br>MAX(concerts.concert_date)  <br>WHERE concerts.tour_id = tours.tour_id  <br>  <br>Использовать триггер - при добавлении или изменении концерта  <br>- пересчитать average_ticket_price  <br>- обновить start_date и end_date |



## Проверка условий по SQL запросам
